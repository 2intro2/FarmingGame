...
const BG_OFFSET_Y = 0
const BG_SCALE_ADJUST = 1.0 // 严格cover，避免黑边

export default class NoodleChallengePage3 {
  ...
  loadResources() {
    ...
    this.backgroundImage.src = 'images/lbg03.png'
    ...
    this.farmerImage.src = 'images/lbg03.png'
  ...
  render(ctx) {
    ...
    // 背景：保持原比例，cover后再整体缩小一点并居中，上移偏移
  ...
  renderOptionsPanel(ctx) {
    ...
    ctx.font = '20px Arial'
    ctx.textAlign = 'left'
    ctx.fillText('请选择正确播种农具给小麦脱粒', 30, y + 30)
  }
  ...
  handleTouch(event) {
    ...
    if (this.result.type === 'pass') {
      ...
      // 第三关通过后跳转到第四关
      GameGlobal.pageManager.switchToPage('noodleChallenge4')
      return
    }
